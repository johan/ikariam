...
tw: { // Taiwanese server
  ...
  lackResources: "沒有足夠的資源",
   ...
   spyWarehouse: "刺探倉庫",
     ...
     buyMsn    : "Käy kauppaa(Osta)",
     buyMsnBack: "Käy kauppaa (Takaisin)",
     selMsn    : "?",
     selMsnUndo: "Käy kauppaa(Myy) (keskeytä)",
     trpMsn    : "Siirrä joukot",
     trpMsnUndo: "Siirrä joukot (keskeytä)",
     tspMsn    : "Kuljeta resursseja",
     tspMsnUndo: "?",
     attMsn    : "Ryöstele",
     attMsnBack: "Ryöstele (Takaisin)",
